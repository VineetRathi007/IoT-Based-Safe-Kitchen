...
class Gsender
{
    ...
    private:
        ...
        const char* EMAIL_LOGIN = "vineet2018cs181abesit@gmail.com"; //sender's gmail ID
        const char* EMAIL_PASSWORD = "rathi@181it"; //sender's gmail account's password
        const char* FROM = "vineet2018cs181@gmail.com"; // sender's gmail ID
        /*------------------------------------------------------*/
